...
public interface PaymentService {
    ...
    PaymentListDTO findPaymentByCustomer(String username,String period,String startDate,String endDate,String paymentMethod,String paymentPartner,int page, int size);
}
